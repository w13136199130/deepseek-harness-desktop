...
describe('desktop client environment', () => {
  it('accepts the Electron-owned kebab query markers', () => {
    expect(parseDesktopClientEnvironment('?deepseek-harness-desktop-mode=advanced&deepseek-harness-desktop-platform=darwin'))
      .toEqual({ mode: 'advanced', platform: 'darwin' })
    expect(parseDesktopClientEnvironment('?deepseek-harness-desktop-platform=win32&deepseek-harness-desktop-mode=compatibility'))
      .toEqual({ mode: 'compatibility', platform: 'win32' })
  })

  it.each([
    ['', 'deepseek-harness-desktop-mode'],
    ['?deepseek-harness-desktop-mode=glass&deepseek-harness-desktop-platform=darwin', 'deepseek-harness-desktop-mode'],
    ['?deepseek-harness-desktop-mode=advanced', 'deepseek-harness-desktop-platform'],
    ['?deepseek-harness-desktop-mode=advanced&deepseek-harness-desktop-platform=android', 'deepseek-harness-desktop-platform'],
