...
body[data-deepseek-harness-desktop-mode="advanced"] { margin: 0; background: transparent !important; }
...
export function installAdvancedStyles(): () => void {
  ...
  style.dataset.plugin = 'deepseek-harness-desktop'
  style.dataset.pluginCss = 'deepseek-harness-desktop/advanced-shell'
