...
// TODO(brand): replace with the product download endpoints before release.
export const DESKTOP_DOWNLOAD_URLS: Readonly<Record<DesktopDownloadPlatform, string>> = {
  darwin: 'https://updates.example.com/deepseek-harness-desktop/downloads/mac',
  win32: 'https://updates.example.com/deepseek-harness-desktop/downloads/windows',
}
