...
export const DESKTOP_PACKAGE_NAME = 'deepseek-harness-desktop'
...
const BROWSE_PICKER_BACKEND = 'deepseek-harness-desktop/directory-picker-browse'
...
const DESKTOP_WINDOWS_PWSH_SANDBOX_PACKAGE = 'deepseek-harness-desktop/windows-pwsh-sandbox'
const DEFAULT_DESKTOP_SHELL_MODE: DesktopShellMode = 'compatibility'
const SETTINGS_FILE_PACKAGE = '@deepseek-ai/dsh-settings-file'
const DESKTOP_SETTINGS_NAMESPACE = 'deepseek-harness-desktop'
