...
const BIN_NAME = 'deepseek-harness-desktop-profile-smoke'
...
try {
  ...
  const expectedUrl = `http://127.0.0.1:${String(ctx.webServer.port)}/?deepseek-harness-desktop-mode=advanced&deepseek-harness-desktop-platform=win32`
